//
//  SHMineZhongDanSubViewController.m
//  ShiHuaRead
//
...
@interface SHMineZhongDanSubViewController ()<UITableViewDelegate,UITableViewDataSource,CTAPIManagerCallBackDelegate,CTAPIManagerParamSource>
...
@implementation SHMineZhongDanSubViewController
...
{
    SHMineAdvertisementListCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell"];
    if (!cell) {
        cell = [[SHMineAdvertisementListCellTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"Cell"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SHEvaluateViewController *evaluteVc = [[SHEvaluateViewController alloc] init];
