...
@interface SHMineTouDanViewController ()
...
@implementation SHMineTouDanViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    ...
    static NSString *gridId = @"mineToudan.identifier";
    SHMineTouDanSubViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[SHMineTouDanSubViewController alloc] init];
    }
