...
@interface SHMineNoticeViewController ()
...
@implementation SHMineNoticeViewController
...
- (void)rightBtn
{
    SHMineNoticeEditorViewController *mineNoticeEditorVc = [[SHMineNoticeEditorViewController alloc] init];
