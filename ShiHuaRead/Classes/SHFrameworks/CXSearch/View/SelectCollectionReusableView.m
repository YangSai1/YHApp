...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width - 60, (self.frame.size.height - 18.0f / 2), 18, 18)];
        
        [self addSubview:imageView];
        
        self.imageView = imageView;
        
        UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(0, (self.frame.size.height - 18.0f / 2), 100.0f, 18)];
        ...
        UIButton *delectButton = [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width - 70 , (self.frame.size.height - 30.0f / 2), 65, 30)];
